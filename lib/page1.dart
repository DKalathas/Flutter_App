...
class _page1 extends State<page1> {
  ...
  Future _speak() async {
    ...
    await flutterTts.speak("the choices are rock an roll and barret");
  }

  String url3 = 'tel:2107210065';
  @override
  void _launchURL3() async {
    if (!await launch(url1)) throw 'Could not launch $url1';
  }

  String url1 = 'https://goo.gl/maps/mv76CskWmnCP4Fg96';
  @override
  void _launchURL1() async {
    if (!await launch(url1)) throw 'Could not launch $url1';
  }

  String url2 = 'https://g.page/Barrett-Bar-Athens?share';
